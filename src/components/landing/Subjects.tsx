const subjects = [
  ...
  { name: "Computer Science", emoji: "🖥️", color: "from-blue-500/20 to-cyan-500/20" },
  { name: "AI", emoji: "🤖", color: "from-purple-500/20 to-fuchsia-500/20" },
  { name: "IT", emoji: "🌐", color: "from-teal-500/20 to-sky-500/20" },
